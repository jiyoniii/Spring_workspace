...
<head>
    ...
    <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries //html5를 익스플로러 8이하를 맞춰주기위한 CDN-->
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="http://localhost:8181/board/list">TIS.Edu</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="notifications.html">FreeBoard</a>
                                </li>
